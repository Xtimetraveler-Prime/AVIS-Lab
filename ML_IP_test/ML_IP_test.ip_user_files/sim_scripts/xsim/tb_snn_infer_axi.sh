...
#
# Script generated by Vivado on Wed Feb 25 11:20:25 -0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_snn_infer_axi.sh
...
#
# Usage        : tb_snn_infer_axi.sh
#                tb_snn_infer_axi.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_snn_infer_axi.sh [-rerun]
#                tb_snn_infer_axi.sh [-reset_run]
#                tb_snn_infer_axi.sh [-clean]
#                tb_snn_infer_axi.sh [-reset_log]
#                tb_snn_infer_axi.sh [-help]
#
...
# script info
echo -e "tb_snn_infer_axi.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_snn_infer_axi.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L xpm -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_snn_infer_axi xil_defaultlib.tb_snn_infer_axi xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_snn_infer_axi -key {Behavioral:sim_1:Functional:tb_snn_infer_axi} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_snn_infer_axi.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_snn_infer_axi.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_snn_infer_axi.sh [-help]\n\
Usage: tb_snn_infer_axi.sh [-step]\n\
Usage: tb_snn_infer_axi.sh [-lib_map_path]\n\
Usage: tb_snn_infer_axi.sh [-rerun]\n\
Usage: tb_snn_infer_axi.sh [-reset_run]\n\
Usage: tb_snn_infer_axi.sh [-clean]\n\
Usage: tb_snn_infer_axi.sh [-reset_log]\n\
Usage: tb_snn_infer_axi.sh [-keep_index]\n\
Usage: tb_snn_infer_axi.sh [-noclean_files]\n\n\
